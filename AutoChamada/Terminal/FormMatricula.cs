...
namespace Terminal
{
    public partial class FormMatricula : Form
    {
        ...
        private void IniciaCombos()
        {
            ...
            DefineCombo(cmbProjetoD4T3, matriculas.projetoD4T3);
        }
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            {
                Program.Erro("Falha ao validar projeto matutino e carga horária vespertina.\r\n" + ex.Message);
                return;
            }
            try
            {
            ...
            {
                Program.Erro("Falha ao construir objeto matutino.\r\n" + ex.Message);
                return;
            }
            try
            {
            ...
            {
                Program.Erro("Falha ao construir objeto segunda-feira.\r\n" + ex.Message);
                return;
            }
            try
            {
            ...
            {
                Program.Erro("Falha ao construir objeto terça.\r\n" + ex.Message);
                return;
            }
            try
            {
            ...
            {
                Program.Erro("Falha ao construir objeto quarta-feira.\r\n" + ex.Message);
                return;
            }
            try
            {
            ...
            {
                Program.Erro("Falha ao construir objeto quinta-feira.\r\n" + ex.Message);
                return;
            }
            try
            {
            ...
            {
                Program.Erro("Falha ao construir objeto sexta-feira.\r\n" + ex.Message);
                return;
            }
            //HORA DE PERSISTIR
            try
